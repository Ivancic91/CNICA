...
[issues]: https://github.com/Ivancic91/CNICA/issues
<!-- prettier-ignore-end -->
...
- Clone your fork locally:
  ...
  ```bash
  git clone git@github.com:your_name_here/CNICA.git
  ```
  ...
  ```bash
  git clone --recursive-submodules git@github.com:your_name_here/CNICA.git
  ```
